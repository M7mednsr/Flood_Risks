...
import mapImage from '../../assets/flood-hazard.jpg';
        ...
        <div className="w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100 transition-all hover:shadow-2xl duration-300 group">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full p-6 md:p-10 lg:p-12 flex flex-col items-center justify-center bg-linear-gradient-to-b from-slate-50 to-white relative text-center">
              ...
              <p className="text-slate-600 text-lg mb-10 leading-relaxed font-medium text-center max-w-5xl mx-auto">
              ...
              <div className="flex flex-col xl:flex-row gap-8 lg:gap-10 w-full max-w-6xl mx-auto justify-center items-stretch">
                ...
                <div className="flex-1 h-full bg-white p-8 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group/box hover:border-blue-200 hover:shadow-[0_8px_30px_rgb(59,130,246,0.1)] transition-all duration-300 flex flex-col items-center">
                  ...
                  <p className="text-slate-600 leading-relaxed text-center text-base flex-1 whitespace-pre-line">
                    توضح الخريطة التوزيع المكاني لمخاطر الفيضانات في منطقة فلورنسا بإيطاليا،باستخدام تصنيف لوني الي ثلاث درجات:الاحمر (خطوره عاليه) الاصفر (خطوره متوسطة) الأخضر (خطوره منخفضة)
يتبين ان المناطق الجبليه في الأجزاء الغربية و الشمالية و الغربية تسجل انخفاضاً واضحاً في خطوره الفيضانات (المناطق الخضراء) وذلك نتيجة الانحدار الشديد وسرعه تصريف المياه مما يقلل من فرص تجمعها.
في المقابل ،تنتشر المناطق متوسطة الخطورة (الصفراء)في نطاقات انتقالية بين الجبال و السهول،حيث تبدأ التضاريس في الاستواء تدريجياً ما يسمح بتراكم جزئي للمياه.
أما المناطق عالية الخطورة (الحمراء)فتتركز في السهول المنخفضة وعلي امتداد المجاري المائية، خاصه بالقرب من الأنهار و المناطق الزراعية و العمرانيه، حيث يزداد احتمال حدوث الفيضانات نتيجة انخفاض الارتفاع و إرتفاع كثافه النشط البشري.
ويلاحظ ان شبكات الأنهار (مثل روافد نهر بو و نهر أرنو)تلعب دوراً محورياً في تحديد نطاقات الخطر الي جانب تأثير استخدامات الأرض التي تقل فيها نفاذية التربة في المناطق العمرانية و الزراعية.
                  </p>
                </div>
        ...
        >
          <div className="relative w-full h-full flex flex-col items-center justify-center max-w-7xl mx-auto">
            ...
            <div className="text-center mb-6 mt-12 sm:mt-0 animate-fade-in-down">
              <h3 className="text-2xl sm:text-4xl font-bold text-white mb-3">مخاطر الفيضانات</h3>
